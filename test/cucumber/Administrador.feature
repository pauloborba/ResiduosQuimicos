Feature: Administrador do sistema
  ...
  Scenario: gerar lista de laboratórios com resíduos a ser coletado (positivo)
    ...
    And eu criei o resíduo "Descartáveis em geral" com peso "4000,0" associado ao laboratório "Laboratório de Enfermagem"
    And eu criei o resíduo "Compostos químicos" com peso "3700,0" associado ao laboratório "Laboratório de Biotecnologia"
  ...
  Scenario: verificar necessidade de coleta de resíduos na UFPE
    ...
    And eu criei o resíduo "Compostos químicos" com peso "4000,0" associado ao laboratório "Coleção de Microorganimos - UFPEDA"
    And eu criei o resíduo "Resíduo sólido" com peso "4600,0" associado ao laboratório "Biotério"
    When eu vou para a página de resumo do sistema
...
#CONTROLLER
  Scenario: buscar percentual de laboratórios com resíduos cadastrados
    ...
    And o sistema possui o resíduo "Compostos químicos" com peso "300,0" associado ao laboratório "Laboratório de Enfermagem"
